  ...
  return (
    <div className="grid gap-6">
      ...
      {values.hasBatteries !== undefined ? (
        <DetailCard
          title={values.hasBatteries ? 'Installed battery storage' : 'Proposed battery storage'}
        >
      ...
      <BooleanField
        ...
        label="Does the household have an electric vehicle?"
      />
