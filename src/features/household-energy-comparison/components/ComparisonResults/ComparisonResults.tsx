...
import { ComparisonResultHeader } from './ComparisonResultHeader'
import { ComparisonResultContent } from './ComparisonResultContent'
import { EstimatedElectricityDemand } from './EstimatedElectricityDemand'
    ...
    return (
      <Card className="border-destructive/40">
        <CardHeader>
          ...
          <CardDescription>
            {comparison.message} Check the monthly bill and try again.
          </CardDescription>
        </CardHeader>
      </Card>
    )
